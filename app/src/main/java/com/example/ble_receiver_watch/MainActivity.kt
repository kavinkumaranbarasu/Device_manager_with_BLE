...
//            }
                    ...
                    if (newState == BluetoothProfile.STATE_CONNECTED) {
                        ...
                        if (ActivityCompat.checkSelfPermission(this@MainActivity, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            runOnUiThread {
                                ...
                                builder.setMessage("Bluetooth connection lost with the"+ SMARTWATCH_MAC_ADDRESS)
    ...
    companion object {
        ...
        private const val SMARTWATCH_MAC_ADDRESS = "78:34:D8:64:18:98" // "64:5D:F4:A6:08:FA" - Galaxy  "F7:6B:D5:29:36:8F"  - GSW "F8:C9:19:1A:07:36" - Fire-bolt
